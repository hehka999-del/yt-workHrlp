...
TitleText.Text = "HUB - Troll & Universal"
            ...
            if targetChar then
                ...
                if thrp then
                    ...
                    if TrollState.AttachMode == "Back" then
                        -- Сзади (Трах): Приподнято по оси Y на 0.15 для точного попадания по тазу
                    ...
                    elseif TrollState.AttachMode == "Front" then
                        -- Спереди (В рот): Приподнято по оси Y до 1.55 для точного попадания к лицу цели
                    ...
                    -- Синхронизация скоростей для репликации движений другим игрокам без задержек (FE Sync)
                    hrp.AssemblyLinearVelocity = thrp.AssemblyLinearVelocity
                    hrp.AssemblyAngularVelocity = thrp.AssemblyAngularVelocity
